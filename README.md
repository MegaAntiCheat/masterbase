...
To inspect the DB, the connection string will be `postgresql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@localhost:8001/demos`

Monitoring is located at `http://127.0.0.1:3000/d/000000039/postgresql-database?orgId=1&refresh=10s` (how can we put this behind some sort of auth?)
